...
public class BaconSapling extends BlockSapling {
		  ...
		  public static final String[] saplings = new String[] {"Bacon"};
		    ...
		    public void func_149878_d(World world, int x, int y, int z, Random random)
		    {
		        ...
		        {
		            case 0:
		            	object = new WorldGenBaconTree(Main.baconWood, Main.baconLeaf, 1, 1, false, 5, 8, false);
		            	break;
		            case 1:
		                break;
		            case 2:
		    ...
		    public void registerBlockIcons(IIconRegister iconRegister)
		    {
		        ...
		        {
		        	iconLength[i] = iconRegister.registerIcon(References.MODID + ":" + "BaconSapling");
		        }
		    }
