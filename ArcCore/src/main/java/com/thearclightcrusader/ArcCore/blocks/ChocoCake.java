...
public class ChocoCake extends Block
{
    ...
    public ChocoCake(Material material)
    {
        super(Material.cake);
        this.setTickRandomly(true);
        this.setBlockTextureName(References.MODID + ":ChocoCake");
    ...
    private void func_150036_b(World p_150036_1_, int p_150036_2_, int p_150036_3_, int p_150036_4_, EntityPlayer p_150036_5_)
    {
        ...
        {
            p_150036_5_.getFoodStats().addStats(3, 0.2F);
    ...
    {
        return Main.chocoCake.getItem(world, x, y, z);
    }
}