...
public class BiomeRedForest extends BiomeGenBase{

	private static final Height biomeHeight = new Height(0.4F, 0.7F);
		
	public BiomeRedForest(int id) {
		super(id);
		
		this.setHeight(biomeHeight);
		this.setColor(10027008);
		this.setTemperatureRainfall(0.7F, 0.7F);
		this.waterColorMultiplier = 2571724;
