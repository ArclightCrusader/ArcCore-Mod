...
import com.thearclightcrusader.ArcCore.worldgen.WorldGenGildedTree;
...
public class GildedSapling extends BlockSapling {
		
		  public static final String[] saplings = new String[] {"Bacon"};
		    private static final IIcon[] iconLength = new IIcon[saplings.length];

		    public GildedSapling()
		    {
		        float f = 0.4F;
		    ...
		    {
		    	meta &= 7;
		        return iconLength[MathHelper.clamp_int(meta, 0, 0)];
		    }
		    ...
		    public void func_149878_d(World world, int x, int y, int z, Random random)
		    {
		        ...
		        {
		            case 0:
		            	object = new WorldGenGildedTree(Main.gildedLog, Main.gildedLeaf, 1, 1, false, 5, 10, false);
		            	break;
		            case 1:
		                break;
		            case 2:
		    ...
		    public void registerBlockIcons(IIconRegister iconRegister)
		    {
		        ...
		        {
		        	iconLength[i] = iconRegister.registerIcon(References.MODID + ":" + "GildedSapling");
		        }
		    }
