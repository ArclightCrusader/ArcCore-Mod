...
public class RenderCyclops extends RenderLiving {
	...
	public static final ResourceLocation texture = new ResourceLocation(References.MODID + ":" + "textures/model/Cyclops.png");
	
	protected ModelCyclops modelEntity;

	public RenderCyclops(ModelBase modelBase, float par2) {
