package com.thearclightcrusader.ArcCore.worldgen.decorator;
...
public class BiomeDecoratorFireLands extends BiomeDecorator
{
    ...
    public BiomeDecoratorFireLands()
    {
        this.sandGen = new WorldGenSand(Blocks.obsidian, 7);
        this.gravelAsSandGen = new WorldGenSand(Blocks.obsidian, 6);
        this.dirtGen = new WorldGenMinable(Blocks.lava, 32);
        this.gravelGen = new WorldGenMinable(Blocks.obsidian, 32);
